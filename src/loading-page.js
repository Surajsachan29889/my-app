  ...
  return (
    <div className="loading">
      <svg id="preloader" width="240px" height="120px" viewBox="0 0 240 120" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <path id="loop-normal" className="st1" d="M120.5,60.5L146.48,87.02c14.64,14.64,38.39,14.65,53.03,0s14.64-38.39,0-53.03s-38.39-14.65-53.03,0L120.5,60.5L94.52,87.02c-14.64,14.64-38.39,14.64-53.03,0c-14.64-14.64-14.64-38.39,0-53.03c14.65-14.64,38.39-14.65,53.03,0z">
      ...
      <div className="credit">
        <a href="https://thenounproject.com/search/?q=energy&i=2064" target="_blank" rel="noopener noreferrer">Please Wait... Redirecting to SURAJ SACHAN Portfolio Website</a>
      </div>
    </div>
  );
}
